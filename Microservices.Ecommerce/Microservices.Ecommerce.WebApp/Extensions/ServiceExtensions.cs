...
namespace Microservices.Ecommerce.WebApp.Extensions
{
    public static class ServiceExtensions
    {
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}\Microservices.Ecommerce.WebApp.xml", System.AppDomain.CurrentDomain.BaseDirectory));
