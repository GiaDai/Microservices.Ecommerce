            ...
            <section className={ "w-80 md:w-96  right-0 absolute bg-base-100 h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " + (isOpen ? " translate-x-0 " : " translate-x-full ")}>
                    ...
                    <div className="relative  pb-5 flex flex-col  h-full">
                        ...
                        <div className="overflow-y-scroll pl-4 pr-4">
                            ...
                            {
                                {
                                        [GLOBAL_CONSTANTS.RIGHT_DRAWER_TYPES.NOTIFICATION] : <NotificationBodyRightDrawer {...extraObject} closeRightDrawer={close}/>,
                                        [GLOBAL_CONSTANTS.RIGHT_DRAWER_TYPES.CALENDAR_EVENTS] : <CalendarEventsBodyRightDrawer {...extraObject} closeRightDrawer={close}/>,
                                        [GLOBAL_CONSTANTS.RIGHT_DRAWER_TYPES.DEFAULT] : <div></div>
                                }[bodyType]
                            }
