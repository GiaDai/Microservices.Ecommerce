            ...
            <article className="prose">
              ...
              <h2 id="component1">Typography</h2>
                <div>
                    ...
                    <Title className="my-title">Title Example</Title>
                </div>
              ...
              <h2 id="component2">Form Input</h2>
                ...
                <InputText type="text" defaultValue={"input value"}  updateType="first_name" containerStyle="mt-3" labelTitle="Label Title" labelStyle="my-label-style" updateFormValue={updateFormValue}/>
